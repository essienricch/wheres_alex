...
import searchAlex  from '../../public/search.jpg';
        ...
        <>
          ...
          >
            <img
              loading='lazy'
              src={searchAlex}
              className='aspect-[2.95] w-[161px] max-w-full self-stretch overflow-hidden fill-white object-cover object-center object-fit'
            />
          </button>
          <Button
            size='sm'
